...
// POST order
// required data: email, cardNumber, CVC, expiryDate
          ...
          if (!err && userData) {
            ...
            if (activeCart){
              ...
              _data.read("carts", activeCart, function(err, cartData){
                if(!err && cartData){
                  // Place an order
                  // Make a helper function based on the following information:
                  // https://stripe.com/docs/testing#cards
                  // Use tokens (eg. tok_visa) as source parameter instead of fake card numbers
              ...
              callback(400, {Error: "There is no active cart dude. Gotta add some pizzas!"})
            }
          } else {
            callback(400, {
