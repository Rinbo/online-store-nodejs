...
handlers.index = function(data,callback){
  ...
  if(data.method == 'get'){
    ...
    const templateData = {
      ...
      'head.description' : 'We offersimple pizza ordering online. When you are hungry, visit our site and make an order',
      'body.class' : 'index'
    };
                      ...
                      helpers.makePayment(
                        ...
                        function(err) {
                          if (!err) {
                            ...
                            helpers.sendReceipt(cartData, price, function(err) {
                              if (!err) {
                                callback(200, {
